...
public class ResearchContractFundedCharitService {
    ...
    public Activity saveResearchContractFundedCharit(@RequestBody Map<String, Object> request)
        ...
        // Type d’activité : à adapter au bon enum si le nom diffère
        ...
        // ⚠️ Adapter le nom du setter à ton modèle Activity
        ...
        if (researcherId != null) {
            activity.setResearcherList(
                    Collections.singletonList(new Researcher(researcherId))
            );
        } else {
