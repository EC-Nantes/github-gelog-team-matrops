...
public class CsvBelongTeam extends DependentCsv<BelongsTeam, String> {
    ...
    public BelongsTeam convertToEntity() {
        ...
        belongsTeam.getResearcher().setResearcherId((this.csvResearcher.getIdDatabase()));
        belongsTeam.getTeam().setTeamId((this.csvTeam.getIdDatabase()));
        return belongsTeam;
    }
    ...
    public int hashCode() {
        int hash = 7;
        hash = 83 * hash + Objects.hashCode(this.idCsvResearcher);
        hash = 83 * hash + Objects.hashCode(this.csvResearcher);
        hash = 83 * hash + Objects.hashCode(this.researcherIdCsvMap);
        hash = 83 * hash + Objects.hashCode(this.idTeamCsv);
        hash = 83 * hash + Objects.hashCode(this.csvTeam);
        hash = 83 * hash + Objects.hashCode(this.teamIdCsvMap);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final CsvBelongTeam other = (CsvBelongTeam) obj;
        ...
        if (!Objects.equals(this.idTeamCsv, other.idTeamCsv)) {
            return false;
        }
        if (!Objects.equals(this.csvTeam, other.csvTeam)) {
            return false;
        }
        return Objects.equals(this.teamIdCsvMap, other.teamIdCsvMap);
    }
