...
public class CsvPlatform extends DependentCsv<Activity, Integer> {
    ...
    public Integer getIdCsvPlatform() {
        return idCsvPlatform;
    }

    public void setIdCsvPlatform(Integer idCsvPlatform) {
        this.idCsvPlatform = idCsvPlatform;
    }
    ...
    public Activity convertToEntity() {
        ...
        type.setIdTypeActivity(TypeActivityId.PLATFORM.getId());
