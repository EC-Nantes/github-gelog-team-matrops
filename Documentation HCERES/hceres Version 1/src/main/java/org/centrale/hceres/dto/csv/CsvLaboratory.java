...
public class CsvLaboratory extends DependentCsv<Laboratory, Integer> {
    ...
    public static int getLABORATORY_NAME_ORDER() {
        return LABORATORY_NAME_ORDER;
    }

    public static int getLABORATORY_ACRONYM_ORDER() {
        return LABORATORY_ACRONYM_ORDER;
    }

    public static int getINSTITUTION_ID_CSV_ORDER() {
        return INSTITUTION_ID_CSV_ORDER;
    }

    public Map<Integer, GenericCsv<Institution, Integer>> getInstitutionIdCsvMap() {
        return institutionIdCsvMap;
    }
    ...
    public Laboratory convertToEntity() {
        ...
        laboratory.getInstitution().setInstitutionId(this.getCsvInstitution().getIdDatabase());
        return laboratory;
    }
