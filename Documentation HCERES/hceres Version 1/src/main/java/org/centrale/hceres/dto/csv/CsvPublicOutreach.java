...
public class CsvPublicOutreach extends DependentCsv<Activity, Integer> {
    ...
    public Integer getIdCsvPublicOutreach() {
        return idCsvPublicOutreach;
    }

    public void setIdCsvPublicOutreach(Integer idCsvPublicOutreach) {
        this.idCsvPublicOutreach = idCsvPublicOutreach;
    }
    ...
    public Activity convertToEntity() {
        ...
        type.setIdTypeActivity(TypeActivityId.PUBLIC_OUTREACH.getId());
        ...
        publicOutreach.getPublicOutreachType().setPublicOutreachTypeId(this.getIdType());
