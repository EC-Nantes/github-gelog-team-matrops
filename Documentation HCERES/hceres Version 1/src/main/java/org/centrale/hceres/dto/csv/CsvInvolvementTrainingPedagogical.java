...
public class CsvInvolvementTrainingPedagogical extends DependentCsv<Activity, Integer> {
    ...
    public Integer getIdCsvInvolvementTrainingPedagogical() {
        return idCsvInvolvementTrainingPedagogical;
    }

    public void setIdCsvInvolvementTrainingPedagogical(Integer idCsvInvolvementTrainingPedagogical) {
        this.idCsvInvolvementTrainingPedagogical = idCsvInvolvementTrainingPedagogical;
    }
