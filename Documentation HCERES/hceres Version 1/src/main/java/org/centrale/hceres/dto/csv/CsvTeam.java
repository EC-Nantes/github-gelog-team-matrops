...
public class CsvTeam extends DependentCsv<Team, Integer> {
    ...
    public Integer getLaboratoryIdCsv() {
        return laboratoryIdCsv;
    }

    public void setLaboratoryIdCsv(Integer laboratoryIdCsv) {
        this.laboratoryIdCsv = laboratoryIdCsv;
    }

    public GenericCsv<Laboratory, Integer> getCsvLaboratory() {
        return csvLaboratory;
    }

    public void setCsvLaboratory(GenericCsv<Laboratory, Integer> csvLaboratory) {
        this.csvLaboratory = csvLaboratory;
    }
    ...
    public Team convertToEntity() {
        ...
        team.getLaboratory().setLaboratoryId(this.getCsvLaboratory().getIdDatabase());
        return team;
    }
