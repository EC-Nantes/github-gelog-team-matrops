...
public class ResearchController {
    ...
    /**
     * pour une requete GET dans localhost/researchs => fournir la liste des
     * chercheurs le resultat est traduit automatiquement en JSON
     *
     * @return : liste des chercheurs
     */
    @GetMapping("/Researchers")
    public Iterable<Researcher> getResearchers() {
        Iterable<Researcher> list = rs.getResearchers();
        System.out.println(">>> [BACK] Nombre de chercheurs : " + (list == null ? "null" : ((Collection<?>) list).size()));
        return list;
    }
