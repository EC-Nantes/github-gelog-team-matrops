...
import org.centrale.hceres.dto.csv.CsvInternationalCollaboration;
...
@Data
@Service
public class ImportCsvInternationalCollaboration {

    @Autowired
    private ActivityRepository activityRepo;

    /**
     * @param internationalCollaborationRows      list of array having fields as defined in csv
     * @param importCsvSummary Summary of the import
     */
    public Map<Integer, GenericCsv<Activity, Integer>> importCsvList(List<?> internationalCollaborationRows, ImportCsvSummary importCsvSummary,
